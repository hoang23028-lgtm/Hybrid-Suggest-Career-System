...
|--------|-------|-----------|
| **Developer A** | Kỹ sư Backend/ML | Lõi AI, API, Cơ sở dữ liệu |
| **Developer B** | Kỹ sư Frontend | Giao diện, Triển khai, Tài liệu |
...
- [ ] Cuộc họp kiểm tra code (30 phút)
- [ ] Hợp nhất PR từ cả hai người
...
### 🔗 Công việc Tích hợp (Cả hai)
- [ ] **W2.SYNC** - Tích hợp API
  - [ ] Developer B: Tích hợp API call vào Frontend
  - [ ] Developer A: Kiểm tra & tối ưu endpoints
  - [ ] Thời gian: 1 ngày
