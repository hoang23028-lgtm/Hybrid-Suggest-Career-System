...
# ============================================================================
MODEL_PATH_KHTN = f"{MODELS_DIR}/rf_model_khtn.pkl"
MODEL_PATH_KHXH = f"{MODELS_DIR}/rf_model_khxh.pkl"
RANDOM_STATE = 42
...
# DỮ LIỆU
# ============================================================================
RAW_DATA_PATH = f"{DATA_DIR}/diem_thi_thpt_2024.csv"  # Dữ liệu gốc THPT 2024
DATA_PATH_KHTN = f"{DATA_DIR}/data_khtn.csv"          # Dữ liệu KHTN đã xử lý
DATA_PATH_KHXH = f"{DATA_DIR}/data_khxh.csv"          # Dữ liệu KHXH đã xử lý
...
VETO_ML_HIGH_THRESHOLD = 50         # ML > ngưỡng trong khi KBS thấp → ML quá lạc quan (thang ML = raw_prob×100)
